...
display_names = [
    'hsCRP-hsCRP, mg/L','HGF','GDF.15-GDF-15, ng/L','CCL21-CCL21, pg/mL','Galectin3-Galectin3, ng/mL',
    'S100A8.A9-S100A8/A9, ng/mL','Thrombomodulin-Thrombomodulin, μmol/L','Osteoprotegerin-Osteoprotegerin, pg/mL',
    'Netrin.1-Netrin-1, pg /mL','BDNF-BDNF, pg/mL','CCL19-CCL19, pg/mL','NT.proBNP-NT-proBNP, pg/mL',
    'White.Blood.Cell-White.Blood.Cell, 10^9/L','Triglycerides-Triglycerides , mmol/L','LDL.C-LDL-C, mmol/L',
    'Red.Blood.Cell-Red.Blood.Cell, ×10^12/L','HDL.C-HDL-C, mmol/L','Baseline.NIH-Baseline NIH Stroke Scale score',
    'BMI-BMI','Age-Age, y','SBP-Baseline systolic blood pressure, mm Hg',
    'DBP-Baseline diastolic blood pressure, mm Hg','Ischemic.stroke.subtype-Ischemic stroke subtype',
